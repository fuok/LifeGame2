...
//	}
	...
	{
//		StartCoroutine (GetAliveAroundCoroutine ());
		int count = 0;
	...
	//	IEnumerator GetAliveAroundCoroutine ()
	//	{
	//		int count = 0;
	//		for (int i = 0; i < 8; i++) {
	...
	//获取当前树周围的8棵树对象，游戏开始时调用一次
	public void GetAllTreesAround ()
	{
